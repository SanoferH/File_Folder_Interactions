...
public class ObjectManipulator : MonoBehaviour
{
    ...
    UnityEngine.GameObject hoverObject = null;
    UnityEngine.GameObject grabObject = null;
    ...
    void GrabHoverObject(UnityEngine.GameObject grbObj, Vector3 controllerPos, Quaternion controllerRot)
    {
    ...
    void ManipulateObject(UnityEngine.GameObject obj, Vector3 controllerPos, Quaternion controllerRot)
    {
