...
public class TestingPunch : MonoBehaviour {
    ...
    {        
        ...
        if (Input.GetKeyDown(KeyCode.Q))
        {
            ...
            UnityEngine.GameObject light = UnityEngine.GameObject.Find("DirectionalLight");
        ...
        if (Input.GetKeyDown(KeyCode.C))
        {
            ...
            UnityEngine.GameObject l = UnityEngine.GameObject.Find("LCharacter");
    ...
    static void tweenStatically( UnityEngine.GameObject gameObject ){
    ...
    void destroyOnComp( object p ){
      UnityEngine.GameObject g = (UnityEngine.GameObject)p;
      Destroy( g );
    }
