...
public class OVROverlayCanvas : MonoBehaviour
{
	...
	void Start()
	{
		...
		UnityEngine.GameObject overlayCamera = new UnityEngine.GameObject(name + " Overlay Camera")
		{
		...
		UnityEngine.GameObject meshRenderer = new UnityEngine.GameObject(name + " MeshRenderer")
		{
#if !DEBUG_OVERLAY_CANVAS
			hideFlags = HideFlags.HideInHierarchy | HideFlags.NotEditable
#endif
		...
		UnityEngine.GameObject overlay = new UnityEngine.GameObject(name + " Overlay")
		{
#if !DEBUG_OVERLAY_CANVAS
			hideFlags = HideFlags.HideInHierarchy | HideFlags.NotEditable
#endif
