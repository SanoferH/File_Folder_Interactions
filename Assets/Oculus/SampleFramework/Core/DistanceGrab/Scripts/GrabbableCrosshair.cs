...
namespace OculusSampleFramework
{
    public class GrabbableCrosshair : MonoBehaviour
    {
        ...
        [SerializeField]
        UnityEngine.GameObject m_targetedCrosshair = null;
        [SerializeField]
        UnityEngine.GameObject m_enabledCrosshair = null;

        private void Start()
        {
            m_centerEyeAnchor = UnityEngine.GameObject.Find("CenterEyeAnchor").transform;
        }
