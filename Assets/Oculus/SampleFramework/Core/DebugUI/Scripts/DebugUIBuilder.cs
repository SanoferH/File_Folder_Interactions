...
public class DebugUIBuilder : MonoBehaviour
{
  ...
  [SerializeField]
  private UnityEngine.GameObject uiHelpersToInstantiate = null;
  ...
  [SerializeField]
  private List<UnityEngine.GameObject> toEnable = null;
  [SerializeField]
  private List<UnityEngine.GameObject> toDisable = null;
  ...
  public void Awake()
  {
    ...
    {
      UnityEngine.GameObject.Instantiate(uiHelpersToInstantiate);
    }
  ...
  public RectTransform AddButton(string label, OnClick handler = null, int buttonIndex = -1, int targetCanvas = 0, bool highResolutionText = false)
  {
    ...
    if(buttonIndex == -1)
        buttonRT = UnityEngine.GameObject.Instantiate(buttonPrefab).GetComponent<RectTransform>();
    else
        buttonRT = UnityEngine.GameObject.Instantiate(additionalButtonPrefab[buttonIndex]).GetComponent<RectTransform>();
  ...
  {
    RectTransform rt = UnityEngine.GameObject.Instantiate(labelPrefab).GetComponent<RectTransform>();
  ...
  {
    RectTransform rt = (RectTransform)UnityEngine.GameObject.Instantiate(sliderPrefab);
  ...
  {
    RectTransform rt = (RectTransform)UnityEngine.GameObject.Instantiate(dividerPrefab);
    AddRect(rt, targetCanvas);
    return rt;
  }
  ...
  {
    RectTransform rt = (RectTransform)UnityEngine.GameObject.Instantiate(togglePrefab);
    AddRect(rt, targetCanvas);
  ...
  {
    RectTransform rt = (RectTransform)UnityEngine.GameObject.Instantiate(radioPrefab);
    AddRect(rt, targetCanvas);
    Text buttonText = rt.GetComponentInChildren<Text>();
    buttonText.text = label;
  ...
  {
      RectTransform textRT = UnityEngine.GameObject.Instantiate(textPrefab).GetComponent<RectTransform>();
