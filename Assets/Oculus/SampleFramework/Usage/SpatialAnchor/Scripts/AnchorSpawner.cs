...
public class AnchorSpawner : MonoBehaviour
{
    ...
    /// </summary>
    public UnityEngine.GameObject AnchorPrefab { get { return anchorPrefab_; } }

    [SerializeField]
    private UnityEngine.GameObject anchorPrefab_ = null;
    ...
    public void PlaceAnchorAtTransform(Transform transform)
    {
        ...
        UnityEngine.GameObject anchorObject = Instantiate(anchorPrefab_);
